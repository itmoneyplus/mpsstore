<%@ Page Language="VB" AutoEventWireup="false" CodeFile="report_interbranch_collection.aspx.vb" Inherits="Reports_report_interbranch_collection" %>
...
<head runat="server">
    <title>Inter Branch Collection Report</title>
                    ...
                    <td class="style3">
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                                           ...
                                           <tr>
                                            ...
                                            <tr class="toolbaar1_tr" >
                                                <td class="toolbaar1_td_rep">
                                                    <asp:LinkButton ID="LinkButton12" runat="server" CssClass="toolbaar1_link_active"  PostBackUrl="~/Reports/report_interbranch_collection.aspx"
    ...
    <br />
      <table align="left" class="w100">
                        ...
                        <td colspan="3" class="rptHead" valign="top" >
                           <b>Inter Branch Collection Report</b>
                        </td>
                        </tr>
                        <tr>
                            <td style="width:300px;">
                                <img alt="" src="../Images/White_Right_Arrow.GIF" />&nbsp;&nbsp;
                                <asp:Label ID="label_1" runat="server" CssClass="label_style"> Please select the purpose of payment:</asp:Label>
                                
                            </td>
                            <td>
                                 <asp:DropDownList runat="server" ID="drpPymtMethod" Width="150px" CssClass="droplist_teller">
                                    <asp:ListItem>All</asp:ListItem>
                                    <asp:ListItem>Loan Repayment</asp:ListItem>
                                    <asp:ListItem>Debt Recovery</asp:ListItem>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                 <asp:Button runat="server" ID="btnReport" Text="Create InterBranch Collection Report" ValidationGroup="rpt"
                                    CssClass="btn" />
                            </td>
                            <td></td>
                        </tr>
                                ...
                                <asp:Panel ID="pnlPrint" runat="server" Width="950px">
                                    <div id="PrintDiv" class="printable" style="width: 100%">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                   Inter Branch Collection Report from <asp:Label ID="lblHead" runat="server" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
