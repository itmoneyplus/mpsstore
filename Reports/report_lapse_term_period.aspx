<%@ Page Language="VB" AutoEventWireup="false" CodeFile="report_lapse_term_period.aspx.vb" Inherits="Reports_report_lapse_term_period" %>
...
<head runat="server">
    <title>Lapse Term Period Report</title>
                    ...
                    <td class="style3">
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                                           ...
                                           <tr>
                                            ...
                                            <tr class="toolbaar1_tr" >
                                                <td class="toolbaar1_td_rep">
                                                    <asp:LinkButton ID="LinkButton14" runat="server" CssClass="toolbaar1_link_active"  PostBackUrl="~/Reports/report_lapse_term_period.aspx"
    ...
    <br />
        <table align="left" class="w100">
                        ...
                        <td colspan="3" class="rptHead" valign="top">
                           <b>Lapse term of period Reports</b>
                        </td>
                        </tr>
                        ...
                        <tr>
                            <td  style="width:250px; padding-bottom:20px;">
                                ...
                                <asp:Label ID="label_1" runat="server" CssClass="label_style">Please enter a beginning date:</asp:Label>
                            </td>
                            <td>
                         ...
                         <tr>
                            <td style="width:250px; padding-bottom:20px;">
                                <img src="../Images/White_Right_Arrow.GIF" alt="" />
                                <asp:Label ID="label1" runat="server" CssClass="label_style">Please enter an ending date:</asp:Label>
                            </td>
                            <td>
                         ...
                         <tr>
                            <td>
                                <img src="../Images/White_Right_Arrow.GIF" alt="" />
                                <asp:Label ID="label2" runat="server" CssClass="label_style">Please select order sort by:</asp:Label>
                            </td>
                            <td>
                               <asp:DropDownList runat="server" ID="drpSort" Width="150px">
                                    <asp:ListItem>Date of Loan</asp:ListItem>
                         ...
                         <tr>
                            <td></td>
                            <td>
                               <asp:Button runat="server" ID="btnReport" Text="Create Lapse Report" ValidationGroup="rpt"
                                    CssClass="btn" />
                            </td>
                            <td></td>
                        </tr>
                                ...
                                <asp:Panel ID="pnlPrint" runat="server" Width="950px">
                                    <div id="PrintDiv" class="printable" style="width: 100%">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                   Lapse term of period Reports from  <asp:Label ID="lblHead" runat="server" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
