<%@ Page Language="VB" AutoEventWireup="false" CodeFile="report_cheque_dishonoured.aspx.vb" Inherits="Reports_report_cheque_dishonoured" %>
            ...
            <td align="left">
                <ul id="navbarMarketing">
                    <li >
                        ...
                        <asp:LinkButton ID="Link_Financial" runat="server"  TabIndex="1" PostBackUrl="~/Customer/Financial_Reports.aspx" Font-Bold="True" 
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                              <tr class="toolbaar1_tr">
                                           ...
                                           <tr>
                                            ...
                                            <tr class="toolbaar1_tr">
                                                <td class="toolbaar1_td_rep">
                                                    <asp:LinkButton ID="LinkButton4" runat="server" CssClass="toolbaar1_link_active" PostBackUrl="~/Reports/report_cheque_dishonoured.aspx"
    ...
    <br />
        <table align="left" class="w100">
                        ...
                        <td colspan="3" class="rptHead" valign="top" >
                           <b>Cheque Cashed Dishonoured Report</b>
                        </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="width:250px; padding-bottom:20px;" >
                                ...
                                &nbsp;&nbsp;<asp:Label ID="label1" runat="server" CssClass="label_style">Please enter a beginning date:</asp:Label></td>
                            <td>
                         ...
                         <tr>
                            <td >
                                <img src="../Images/White_Right_Arrow.GIF" alt="" />
                                &nbsp;&nbsp;<asp:Label ID="label2" runat="server" CssClass="label_style"> Please enter an ending date:</asp:Label></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                               <asp:Button runat="server" ID="btnReport" 
                                    Text="Create Dishonoured Cheque(s) Report" ValidationGroup="rpt"
                                    CssClass="btn" />
                               ...
                               <asp:Panel ID="pnlPrint" runat="server" Width="950px">
                                    <div id="PrintDiv" class="printable" style="width: 100%">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                   Cheque Cashed Dishonoured Report for the period  <asp:Label ID="lblHead" runat="server" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                        ...
                        <tr>
                            <td colspan="3" style="text-align: center;">
                               ...
                               <asp:Button ID="btnPrint" runat="server" Text="View & Print" />
                                <br />
                                <br />
                            </td>
                        </tr>
