<%@ Page Language="VB" AutoEventWireup="false" CodeFile="report_debt_recovery.aspx.vb" Inherits="Reports_report_debt_recovery" %>
...
<head runat="server">
    <title>Debt Recovery Report</title>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                             <tr class="toolbaar1_tr">
                                           ...
                                           <tr>
                                            ...
                                            <tr class="toolbaar1_tr">
                                                <td class="toolbaar1_td_rep">
                                                    <asp:LinkButton ID="LinkButton15" runat="server"  CssClass="toolbaar1_link_active"   PostBackUrl="~/Reports/report_debt_recovery.aspx"
        ...
        <table align="left" class="w100">
                        ...
                        <tr>
                         ...
                         <tr>
                            <td></td>
                            <td>
                                  <asp:Button runat="server" ID="btnReport" Text="Create Debt Recovery Report"
