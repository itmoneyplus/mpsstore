<%@ Page Language="VB" AutoEventWireup="false" CodeFile="report_sales.aspx.vb" Inherits="Reports_report_sales" %>
                    ...
                    <td class="style3">
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                              <tr class="toolbaar1_tr">
                                            ...
                                            <tr class="toolbaar1_tr">
                                                <td class="toolbaar1_td_rep">
                                                    <asp:LinkButton ID="Link_sales" runat="server" CssClass="toolbaar1_link_active"  PostBackUrl="~/Reports/report_sales.aspx"
        ...
        <table align="left" class="w100">
                        ...
                        <tr>
                            <td style="width:250px;">
                                ...
                                <asp:Label ID="label_1" runat="server" CssClass="label_style">Please Select Teller:</asp:Label>
                                
                            </td>
                            <td>
                                <asp:DropDownList ID="drpTeller" runat="server" CssClass="droplist_teller">
                                </asp:DropDownList>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button runat="server" ID="btnReport" 
                                    Text="Create Sales Report" ValidationGroup="rpt"
                                    CssClass="btn" />
                                 ...
                                 <asp:Panel ID="pnlPrint" runat="server" Width="950px">
                                    <div id="PrintDiv" class="printable" style="width: 100%">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                  <asp:Label ID="lblTellerName" runat="server" Text=" "></asp:Label>  Sales Report from  <asp:Label ID="lblHead" runat="server" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
