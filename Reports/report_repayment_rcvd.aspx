<%@ Page Language="VB" AutoEventWireup="false" CodeFile="report_repayment_rcvd.aspx.vb" Inherits="Reports_report_repayment_rcvd" %>
...
<head runat="server">
    <title>Repayment Received</title>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                                <tr class="toolbaar1_tr">
                                           ...
                                           <tr>
                                            ...
                                            <tr class="toolbaar1_tr">
                                                <td class="toolbaar1_td_rep">
                                                    <asp:LinkButton ID="LinkButton10" runat="server" CssClass="toolbaar1_link_active"  PostBackUrl="~/Reports/report_repayment_rcvd.aspx"
    ...
    <br />
        <table align="left" class="w100">
                        ...
                        <td colspan="3" class="rptHead" valign="top">
                           <b>Re-Payments Received Report</b>
                        </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                               <asp:Button runat="server" ID="btnReport" 
                                    Text="Create Re-Payments Received Report" ValidationGroup="rpt"
                                    CssClass="btn" />
                            </td>
                            <td></td>
                        </tr>
                                ...
                                <asp:Panel ID="pnlPrint" runat="server" Width="950px">
                                    <div id="PrintDiv" class="printable" style="width: 100%">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                   Re-Payments Received Report from <asp:Label ID="lblHead" runat="server" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
