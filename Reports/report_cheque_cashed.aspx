<%@ Page Language="VB" AutoEventWireup="false" CodeFile="report_cheque_cashed.aspx.vb" Inherits="Reports_report_cheque_cashed" %>
...
<head runat="server">
    <title>Cheque Cashed Report</title>
                    ...
                    <td class="style3">
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                              <tr class="toolbaar1_tr">
                                            ...
                                            <tr class="toolbaar1_tr">
                                                <td class="toolbaar1_td_rep">
                                                    <asp:LinkButton ID="LinkButton3" runat="server" CssClass="toolbaar1_link_active"  PostBackUrl="~/Reports/report_cheque_cashed.aspx"
                        ...
                        <tr>
                            ...
                            <td>
                               <asp:Button runat="server" ID="btnReport" 
                                    Text="Create Cheque Cashed Report" ValidationGroup="rpt"
                                    CssClass="btn" />
                                ...
                                <asp:Panel ID="pnlPrint" runat="server" Width="950px">
                                    <div id="PrintDiv" class="printable" style="width: 100%">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                   Cheque Cashed Report for the period <asp:Label ID="lblHead" runat="server" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
