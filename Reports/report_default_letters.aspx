<%@ Page Language="VB" AutoEventWireup="false" CodeFile="report_default_letters.aspx.vb"
    Inherits="Reports_report_default_letters" %>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                                <tr class="toolbaar1_tr">
                                           ...
                                           <tr>
                                            ...
                                            <tr class="toolbaar1_tr" >
                                                <td class="toolbaar1_td_rep">
                                                    <asp:LinkButton ID="LinkButton13" runat="server" CssClass="toolbaar1_link_active"  PostBackUrl="~/Reports/report_default_letters.aspx"
        ...
        <table align="left" class="w100">
                        ...
                        <tr>
                            <td style="width:290px;">
                               ...
                               <asp:Label ID="label_1" runat="server" CssClass="label_style">Please select the notices type:</asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList runat="server" ID="drp" Width="150px" CssClass="droplist_teller">
                                    <asp:ListItem Value="">Please Select</asp:ListItem>
                                    <asp:ListItem>Created Notices</asp:ListItem>
                                    <asp:ListItem>Expired Notices</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        ...
                        <tr>
                            <td style="width:290px; padding-bottom:20px;">
                                <img src="../Images/White_Right_Arrow.GIF" alt="" />
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtFrmDate"
                                    Display="None" ErrorMessage="Report beginning date Required" ValidationGroup="rpt"></asp:RequiredFieldValidator>
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="drp"
                                    Display="None" ErrorMessage="Please select notices type" ValidationGroup="rpt" InitialValue=""></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                         <tr>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td>
                               <asp:Button runat="server" ID="btnReport" Text="Create Notices Report"
                                 ...
                                 <asp:Panel ID="pnlPrint" runat="server" Width="950px">
                                    <div id="PrintDiv" class="printable" style="width: 100%">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                   <asp:Label ID="lblHead1" runat="server" Text=""></asp:Label>  Report from
