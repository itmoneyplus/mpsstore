<%@ Page Language="VB" AutoEventWireup="false" CodeFile="report_loan_debtor.aspx.vb" Inherits="Reports_report_loan_debtor" %>
...
<head runat="server">
    <title>Loan / LOC Debtor Report</title>
                    ...
                    <td class="style3">
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                                           ...
                                           <tr>
                                            ...
                                            <tr class="toolbaar1_tr">
                                                <td class="toolbaar1_td_rep">
                                                    <asp:LinkButton ID="LinkButton5" runat="server" CssClass="toolbaar1_link_active" PostBackUrl="~/Reports/report_loan_debtor.aspx"
    ...
    <br />
        <table align="left" class="w100">
                        ...
                        <td colspan="3" class="rptHead" valign="top">
                           <b>Loan / LOC Debtor Report</b>
                        </td>
                        </tr>
                        <tr>
                            <td style="width:250px; padding-bottom:20px;">
                                <img src="../Images/White_Right_Arrow.GIF" alt="" />
                                &nbsp;&nbsp;<asp:Label ID="label_1" runat="server" CssClass="label_style">Please select the debtor type:</asp:Label>
                            </td>
                            <td style="padding-bottom:20px;">
                                <asp:CheckBox ID="chkLoan" runat="server" Text=" Loan"  /> &nbsp; &nbsp;
                                <asp:CheckBox ID="chkLoc" runat="server" Text=" LOC" />
                                <br />
                            </td>
                         ...
                         <tr>
                            <td>
                                <img src="../Images/White_Right_Arrow.GIF" alt="" />
                                &nbsp;&nbsp;<asp:Label ID="label1" runat="server" CssClass="label_style">Please select the debtor category:</asp:Label>
                            </td>
                            <td>
                                <asp:CheckBox ID="chkCurrent" runat="server" Text=" Current" /> &nbsp; 
                                <asp:CheckBox ID="chkDefault" runat="server" Text=" Default" /> &nbsp;
                                <asp:CheckBox ID="chkWof" runat="server" Text=" Written-Off" /> &nbsp; 
                                <asp:CheckBox ID="chkHOD" runat="server" Text=" On Hold" />
                                      </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                 <asp:Button ID="btnReport" runat="server" Text="Create Debtor Report"  CssClass="btn"/> &nbsp;
                            </td>
                            <td></td>
                        </tr>
                        <tr >
                                ...
                                <asp:Panel ID="pnlPrint" runat="server" Width="950px">
                                    <div id="PrintDiv" class="printable" style="width: 100%">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblHead1" runat="server"></asp:Label> &nbsp;Debtor Report as at   <asp:Label ID="lblHead" runat="server" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
