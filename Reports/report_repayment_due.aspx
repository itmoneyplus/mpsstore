<%@ Page Language="VB" AutoEventWireup="false" CodeFile="report_repayment_due.aspx.vb"
    Inherits="Reports_report_repayment_due" %>
                    ...
                    <td class="style3">
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                                           ...
                                           <tr>
                                            ...
                                            <tr class="toolbaar1_tr">
                                                <td class="toolbaar1_td_rep">
                                                    <asp:LinkButton ID="LinkButton9" runat="server"  CssClass="toolbaar1_link_active"  PostBackUrl="~/Reports/report_repayment_due.aspx"
    ...
    <br />
        <table align="left" class="w100">
                        ...
                        <td colspan="3" class="rptHead" valign="top">
                           <b>Re-Payments Due Report</b>
                        </td>
                        </tr>
                        <tr>
                            <td style="width:290px;">
                                <img src="../Images/White_Right_Arrow.GIF" alt="" />
                                 <asp:Label ID="label_1" runat="server" CssClass="label_style">Please select the method of repayment:</asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td></td>
                            <td>
                                <asp:Button runat="server" ID="btnReport" Text="Create Re-Payments Due Report" ValidationGroup="rpt"
                                    CssClass="btn" />
                            </td>
                            <td></td>
                        </tr>
                                 ...
                                 <asp:Panel ID="pnlPrint" runat="server" Width="950px">
                                    <div id="PrintDiv" class="printable" style="width: 100%">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                   Re-Payments Due Report from <asp:Label ID="lblHead" runat="server" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
