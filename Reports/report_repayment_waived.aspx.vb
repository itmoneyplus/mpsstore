Imports System.Data
Partial Class Reports_report_repayment_waived
    ...
    Sub bindReport()
        Try
            ...
            Using obj As New clsReport()
                ...
                Dim ds As DataSet = obj.getRepaymentWaived(Date.Parse(txtFrmDate.Text), Date.Parse(txtToDate.Text))
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    sb.Append("<th width='15%' class='center'>Loan Date</th>")
                    sb.Append("<th width='15%' class='center'>Date Waived</th>")
                    ...
                    For Each dr In ds.Tables(0).Rows
                        ...
                        Dim paymentDate As String = Convert.ToDateTime(dr("Transaction_Date"))
