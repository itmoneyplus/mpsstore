...
Imports System.Data
Partial Class Customer_Print_Loan_Status
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        dt1 = Convert.ToDateTime(Session("dt1_loanstatus"))
        dt2 = Convert.ToDateTime(Session("dt2_loanstatus"))

        Dim new_from_loanstatus, new_to_loanstatus As String
        new_from_loanstatus = Date.Parse(Session("dt2_loanstatus")).ToString("yyyy-MM-dd")
        new_to_loanstatus = Date.Parse(Session("dt1_loanstatus")).ToString("yyyy-MM-dd")
        Print_from_loanstatus = Session("dt2_loanstatus")
        Print_to_loanstatus = Session("dt1_loanstatus")
        ...
        Response.Write("<tr>")
        Response.Write("<td style='border: 1px solid #C0C0C0;background-color:#EEEEEE'><b>&nbsp;Loan ID</b></td>")
        Response.Write("<td style='border: 1px solid #C0C0C0;background-color:#EEEEEE'><b>&nbsp;Customer_ID</b></td>")
        Response.Write("<td style='border: 1px solid #C0C0C0;background-color:#EEEEEE'><b>&nbsp;Status</b></td>")
        Response.Write("<td style='border: 1px solid #C0C0C0;background-color:#EEEEEE'><b>&nbsp;Customer Name</b></td>")
        Response.Write("<td style='border: 1px solid #C0C0C0;background-color:#EEEEEE'><b>Date of Loan&nbsp;</b></td> ")
        Response.Write("</tr>")
        ...
        If Not ds_loanstatus.Tables(0).Rows.Count = 0 Then
            ...
            For i = 0 To ds_loanstatus.Tables(0).Rows.Count - 1
                ...
                With Response
                    .Write("<tr>")
                    .Write("<td style='border: 1px solid #C0C0C0;text-align:left'>&nbsp;" & ds_loanstatus.Tables(0).Rows(i).Item("Loan_ID").ToString & "</td>")
                    .Write("<td style='border: 1px solid #C0C0C0'>&nbsp;" & Session("branch_prefix") & " " & ds_loanstatus.Tables(0).Rows(i).Item("Customer_ID").ToString & "</td>")
                    .Write("<td style='border: 1px solid #C0C0C0'>&nbsp;" & str_status & "</td>")
                    .Write("<td style='border: 1px solid #C0C0C0'>&nbsp;" & ds_loanstatus.Tables(0).Rows(i).Item("Given_Name").ToString & " " & ds_loanstatus.Tables(0).Rows(i).Item("Last_Name").ToString & "</td>")
                    .Write("<td style='border: 1px solid #C0C0C0;text-align:right'>" & fn_FormatMPDate(ds_loanstatus.Tables(0).Rows(i).Item("Loan_Date").ToString) & "&nbsp;</td>")
                    .Write("</tr>")
                End With
        ...
        Response.Write("<tr>")
        Response.Write("<td colspan='4' style='border: 1px solid #C0C0C0;text-align:right'><b>Loans Approved&nbsp;</b></td>")
        Response.Write("<td style='border: 1px solid #C0C0C0;text-align:right'><b>" & int_Approved & "</b></td>")
        Response.Write("</tr>")
        Response.Write("<tr>")
        Response.Write("<td colspan='4' style='border: 1px solid #C0C0C0;text-align:right'><b>Loans Declined&nbsp;</b></td>")
        Response.Write("<td style='border: 1px solid #C0C0C0;text-align:right'><b>" & int_Declined & "</b></td>")
        Response.Write("</tr>")
        Response.Write("<tr>")
        Response.Write("<td colspan='4' style='border: 1px solid #C0C0C0;text-align:right'><b>Loans Pending&nbsp;</b></td>")
        Response.Write("<td style='border: 1px solid #C0C0C0;text-align:right'><b>" & int_Pending & "</b></td>")
        Response.Write("</tr>")
        Response.Write("<tr>")
        Response.Write("<td colspan='4' style='border: 1px solid #C0C0C0;text-align:right'><b>Total Loans&nbsp;</b></td>")
        Response.Write("<td style='border: 1px solid #C0C0C0;text-align:right'><b>" & int_No & "</b></td>")
        Response.Write("</tr>")
        Response.Write("<tr>")
        Response.Write("<td colspan='4' style='border: 1px solid #C0C0C0;text-align:right'><b>Total loans found for this branch&nbsp;</b></td>")
        Response.Write("<td style='border: 1px solid #C0C0C0;text-align:right'><b>" & int_Total_Loans & "</b></td>")
        Response.Write("</tr>")
