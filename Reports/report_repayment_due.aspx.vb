Imports System.Data
Partial Class Reports_report_repayment_due
    ...
    Sub bindReport()
        Try
            ...
            Using obj As New clsReport()
                ...
                Dim ds As DataSet = obj.getRepaymentDue(Date.Parse(txtFrmDate.Text), Date.Parse(txtToDate.Text), drpPymtMethod.SelectedItem.Text)
                Dim sb As New StringBuilder()
                Dim total As Decimal = 0
                If ds.Tables(0).Rows.Count > 0 Then
                    sb.Append("<table  width='99%' cellpadding='0' cellspacing='0' align='centre' class='tblreport_new'>")
                    sb.Append("<tr >")
                    sb.Append("<th width='15%' class='center'>Customer No</th>")
                    sb.Append("<th width='30%' class='center'>Customer Name</th>")
