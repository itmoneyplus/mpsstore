<%@ Page Language="VB" AutoEventWireup="false" CodeFile="report_repayment_waived.aspx.vb" Inherits="Reports_report_repayment_waived" %>
                    ...
                    <td class="style3">
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                                           ...
                                           <tr>
                                            ...
                                            <tr class="toolbaar1_tr">
                                                <td class="toolbaar1_td_rep">
                                                    <asp:LinkButton ID="LinkButton11" runat="server" CssClass="toolbaar1_link_active"  PostBackUrl="~/Reports/report_repayment_waived.aspx"
                         ...
                         <tr>
                            ...
                            <td>
                               <asp:Button runat="server" ID="btnReport" 
                                    Text="Create Re-Payments Waived Report" ValidationGroup="rpt"
                                    CssClass="btn" />
                            </td>
                            <td></td>
                        </tr>
                                ...
                                <asp:Panel ID="pnlPrint" runat="server" Width="950px">
                                    <div id="PrintDiv" class="printable" style="width: 100%">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                   Re-Payments Waived Report from  <asp:Label ID="lblHead" runat="server" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
