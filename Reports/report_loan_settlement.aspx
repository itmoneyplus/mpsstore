<%@ Page Language="VB" AutoEventWireup="false" CodeFile="report_loan_settlement.aspx.vb"
    Inherits="Reports_report_loan_settlement" %>
                    ...
                    <td class="style3">
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                                           ...
                                           <tr>
                                            ...
                                            <tr class="toolbaar1_tr" >
                                                <td class="toolbaar1_td_rep">
                                                    <asp:LinkButton ID="LinkButton6" runat="server" CssClass="toolbaar1_link_active"  PostBackUrl="~/Reports/report_loan_settlement.aspx"
        ...
        <table align="left" class="w100">
                        <tr>
                            <td colspan="3" class="rptHead" valign="top">
                                <b>Loan / LOC Settlement Report</b>
                            </td>
                        </tr>
                        <tr>
                            <td  style="width:250px; padding-bottom:20px;">
                                <img src="../Images/White_Right_Arrow.GIF" alt="" />
                                &nbsp;&nbsp;<asp:Label ID="label_1" runat="server" CssClass="label_style">Please Select Type:</asp:Label>
                            </td>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                 <asp:Button runat="server" ID="btnReport" Text="Create Loan / LOC Settlement Report" ValidationGroup="rpt"
                                    CssClass="btn" />
                            </td>
                            <td></td>
                        </tr>
                                ...
                                <asp:Panel ID="pnlPrint" runat="server" Width="950px">
                                    <div id="PrintDiv" class="printable" style="width: 100%">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblHead1" runat="server" ></asp:Label> Settlement Report from 
