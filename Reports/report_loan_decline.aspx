<%@ Page Language="VB" AutoEventWireup="false" CodeFile="report_loan_decline.aspx.vb" Inherits="Reports_report_loan_decline" %>
...
<head runat="server">
    <title>Loan Decline Report</title>
                    ...
                    <td class="style3">
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                                           ...
                                           <tr>
                                            ...
                                            <tr class="toolbaar1_tr" >
                                                <td class="toolbaar1_td_rep">
                                                    <asp:LinkButton ID="LinkButton16" runat="server"   CssClass="toolbaar1_link_active"  PostBackUrl="~/Reports/report_loan_decline.aspx"
        ...
        <table align="left" class="w100">
                        ...
                        <tr>
                         ...
                         <tr>
                            <td></td>
                            <td>
                                <asp:Button runat="server" ID="btnReport" Text="Create Loan Decline Report" ValidationGroup="rpt"
                                    CssClass="btn" />
                            </td>
                            <td></td>
                        </tr>
