<%@ Page Language="VB" AutoEventWireup="false" CodeFile="report_directdebit_dishonoured.aspx.vb"
    Inherits="Reports_report_directdebit_dishonoured" %>
...
<head runat="server">
    <title>Direct Debit Dishonoured</title>
        ...
        <tr>
            <td align="left">
                <ul id="navbarMarketing">
                    ...
                    <li>
                         <asp:LinkButton ID ="lnkbtnDecline" runat="server"  TabIndex="3"  PostBackUrl="~/Customer/Declined_Customers.aspx">Declined Reports</asp:LinkButton>
                    </li>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                                        <tr class="toolbaar1_tr">
                                           ...
                                           <tr>
                                            ...
                                            <tr class="toolbaar1_tr" >
                                                <td class="toolbaar1_td_rep">
                                                    <asp:LinkButton ID="LinkButton8" runat="server"  CssClass="toolbaar1_link_active"  PostBackUrl="~/Reports/report_directdebit_dishonoured.aspx"
        ...
        <table align="left" class="w100">
                        <tr>
                            <td colspan="3" class="rptHead" valign="top">
                                <b>Direct Debit Dishonoured Report</b>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <asp:Button runat="server" ID="btnReport" Text="Create DDs Dishonoured Report" ValidationGroup="rpt"
                                    CssClass="btn" />
                            </td>
                            <td></td>
                        </tr>
                                 ...
                                 <asp:Panel ID="pnlPrint" runat="server" Width="950px">
                                    <div id="PrintDiv" class="printable" style="width: 100%">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    Direct Debit Dishonoured report from
