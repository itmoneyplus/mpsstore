<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Calc_detail.aspx.vb" Inherits="Calc_detail" %>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                             ...
                             <tr class="toolbaar1_tr">
                                <td class="toolbaar1_td_rep">
                                     <asp:LinkButton ID="Link_Calc_loan" runat="server" CssClass="toolbaar1_link" PostBackUrl="~/Calculators/Calc_Loan.aspx"
