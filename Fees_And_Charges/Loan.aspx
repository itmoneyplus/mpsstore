                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                             ...
                             <tr class="toolbaar1_tr">
                                <td class="toolbaar1_td_rep">
                                     <asp:LinkButton ID="Link_loan" runat="server" CssClass="toolbaar1_link_active"  PostBackUrl="~/Fees_And_Charges/Loan.aspx"
                                                    ...
                                                    <td>
                                                        <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC"
                                                            ...
                                                            <Columns>                                                                
                                                                ...
                                                                <asp:BoundField DataField="Application_Fee" HeaderText="Application Fee" DataFormatString="{0:C0}">
                                                                    <%--<HeaderStyle Width="150px" />--%>
                                                                </asp:BoundField>
                                                                
                                                                <asp:BoundField DataField="Credit_Fee" HeaderText="Credit Fee" DataFormatString="{0:C0}">
                                                                    <%--<HeaderStyle Width="80px" />--%>
                                                                </asp:BoundField>
                                                               ...
                                                               <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:Label runat="server" ID="lblperiod" Text ='<%#Eval("Period") %>' ></asp:Label>
                                                                    </ItemTemplate>
                                                                    <HeaderTemplate>
                                                                        <asp:Label ID="Label1" runat="server" Text="Period"></asp:Label>
                                                                        <asp:DropDownList ID="DropDownList_sort" runat="server"  AutoPostBack="True" OnSelectedIndexChanged="DropDownList_sort_OnSelectedIndexChanged" >
