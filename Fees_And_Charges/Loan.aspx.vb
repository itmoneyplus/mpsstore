...
Partial Class Loan
    ...
    End Sub
    Sub sort(ByVal value As String)
        Using obj As New clsReport()
            Dim ds As DataSet = obj.getLoan(value)
    ...
    Protected Sub LinkButton_Back_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LinkButton_back.Click
        ...
        End If
    End Sub
    Protected Sub DropDownList_sort_OnSelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
       
        Dim index As String = sender.SelectedValue.ToString
        If index = "All" Then
            View_Data()
        Else
            sort(index)
