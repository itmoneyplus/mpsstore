<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Draw_down.aspx.vb" Inherits="Draw_down" %>
                ...
                <tr runat="server" id="trreportAdmin" visible="true">
                    <td class="style3">
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                            ...
                            <tr class="toolbaar1_tr">
                                <td class="toolbaar1_td_rep">
                                     <asp:LinkButton ID="Link_draw_down" runat="server" CssClass="toolbaar1_link_active" PostBackUrl="~/Fees_And_Charges/Draw_down.aspx"
                                                    ...
                                                    <td>
                                                        <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC"
                                                            ...
                                                            <Columns>                                                                
                                                                ...
                                                                <asp:BoundField DataField="Application_Fee" HeaderText="Application Fee">
                                                                    <%--<HeaderStyle Width="150px" />--%>
                                                                </asp:BoundField>
                                                                
                                                                <asp:BoundField DataField="Credit_Fee" HeaderText="Credit Fee">
                                                                    <%--<HeaderStyle Width="80px" />--%>
                                                                </asp:BoundField>
