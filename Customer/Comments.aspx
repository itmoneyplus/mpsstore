<%@ Page Language="VB" Culture="en-AU" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Comments.aspx.vb"  Inherits="Customer_Comments" EnableViewState ="true"  %>
...
<%@ Register Src="~/toolbaar/tool.ascx" TagName="Toolbaar3"  TagPrefix="tool3"%>
 ...
 <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
   ...
   <asp:Panel ID="Panel1" runat="server" CssClass="customerContent">
                    ...
                    <td style="border:1px solid gray; width:82%;vertical-align :top">
                        ...
                        <br />
                                <table class="table_AddBank">
                                   <tr><td class="align" ><span class="italics1-doc">Comments</span><br /></td></tr>  
                                    <tr><td class="align-center" >
                                    <i><b>
                                    <asp:Label ID="Label5" runat="server" Text="Add Comments" CssClass ="label_italics" Width ="230px" Height="24px" Visible ="false"></asp:Label> 
                                    </b></i>
                                    <br />   
                                   
                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" 
                                    BorderStyle="Solid" BorderWidth="1px" CellPadding="4" Font-Size="14px" 
                                    ForeColor="Black"  Width="100%" 
                                    CellSpacing="2"  
                                     HorizontalAlign="Center" AutoGenerateDeleteButton="True" 
                                     AutoGenerateEditButton="True" DataKeyNames="Comment_ID" >
                                     <RowStyle BackColor="White" HorizontalAlign="Left" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px"  />
                                    <Columns >
                                     <asp:TemplateField HeaderText="Notes &amp; Comments">
                                     <EditItemTemplate>
                                     <asp:TextBox ID="TextBox1" Width="98%" runat="server" Text='<%# Bind("Comment") %>'></asp:TextBox>
                                     </EditItemTemplate>
                                     <ItemTemplate>
                                     <asp:Label ID="Label1" runat="server" Text='<%# Bind("Comment") %>'></asp:Label>
                                     </ItemTemplate>
                                         <ControlStyle Width="850px" />
                                     </asp:TemplateField>
                                     <asp:BoundField DataField="Added_By" HeaderText="Added By" ItemStyle-CssClass="align-right" ReadOnly="true" >
                                         <ControlStyle Width="50px" />
                                         
                                     <ItemStyle CssClass="align-center" HorizontalAlign="Center" 
                                             VerticalAlign="Middle" />
                                        
                                     </asp:BoundField>
                                     <asp:BoundField DataField="Added_On" HeaderText="Date" ItemStyle-CssClass="align-center" ReadOnly="true" DataFormatString="{0:d}">
                                        <ControlStyle Width="150px" />
                                     <ItemStyle CssClass="align-center" Width="200px" Wrap="False" />
                                     </asp:BoundField>
                                     <asp:BoundField DataField="time_on" HeaderText="Time" ItemStyle-CssClass="align-center" ReadOnly="true" DataFormatString="{0:T}" >
                                        <ControlStyle Width="150px" /> 
                                     <ItemStyle CssClass="align-center" Width="200px" Wrap="False" />
                                     </asp:BoundField>
                                     </Columns>
                                    ...
                                    <br/></td></tr>   
                                    <tr><td>
                                    <asp:TextBox ID="txtaddcmnt" runat="server" Width="99%" Height="150px" TextMode ="MultiLine"  ></asp:TextBox>
                                    </td></tr>  
                                    <tr><td class="align-center">
                                    <asp:Button ID="btncncl" runat="server" Text="Cancel"  Width ="110" Visible="false" /> &nbsp;&nbsp;&nbsp;<asp:Button ID="btnsave" Width ="120" runat="server" Text="Save Comments" />
                                    </td></tr> 
                                     <tr><td class="align-center">
                                     <asp:Button ID="btnadd" runat="server" Text="Add Comments" />
                                     </td></tr>
                                    </table>  
