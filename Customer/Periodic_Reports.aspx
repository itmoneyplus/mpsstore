<%@ Page Language="VB" Culture="en-AU" AutoEventWireup="false" CodeFile="Periodic_Reports.aspx.vb" Inherits="Customer_Periodic_Reports" %>
                    ...
                    <td class="style3">
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                           ...
                           <tr class="toolbaar1_tr" visible="false">
                                <td class="toolbaar1_td_rep">
                                    <asp:LinkButton ID="lbLoginReport" runat="server" CssClass="toolbaar1_link" PostBackUrl="~/Customer/login_track_report.aspx"
