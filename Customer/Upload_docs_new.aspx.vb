...
Imports System.Data
Imports System.IO
Partial Class Customer_Upload_docs_new
    ...
    Protected Sub btnupload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnupload.Click
        ...
        If FileUpload1.HasFile Then
            Try
                ...
                str_sav_document = "update Tbl_Customer set Current_Bank_Statement = @file_name,Current_Bank_Statement_yes=1 where customer_id=@Customer_ID"
                cmd_sav_document.Connection = open_con.return_con
                cmd_sav_document.CommandText = str_sav_document
                cmd_sav_document.Parameters.Add("@Customer_ID", SqlDbType.Int).Value = open_con.customer_id_val
                cmd_sav_document.Parameters.Add("@file_name", SqlDbType.VarChar, 255).Value = FileUpload1.FileName
                cmd_sav_document.ExecuteNonQuery()

                cmd_sav_document.Dispose()
                open_con.return_con.Close()
                Page.ClientScript.RegisterStartupScript(Me.GetType(), "MyAlert", "alert('" & "Document Uploaded!!!" & "');", True)

            Catch ex As Exception
                Response.Write(ex.Message)
            End Try
        Else
            Page.ClientScript.RegisterStartupScript(Me.GetType(), "MyAlert", "alert('" & "You have not specified a file!!!" & "');", True)
        End If
