<%@ Page Language="VB" Culture="en-AU" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Customer_File.aspx.vb" Inherits="Customer_Customer_File" %>
                    ...
                    <td style="border:1px solid gray; width:82%;vertical-align :top">
                        ...
                        <br />
                                    ...
                                    <div align="center">
                                            ...
                                            <asp:Label ID="L1" runat="server"  CssClass ="label_italics" Text="No Documents Download"  ></asp:Label>
                                            </td>
                                            </tr>
                                            <tr>
                                            <td class="align-center" >
                                            ...
                                            Width="100%" DataKeyNames ="Current_Bank_Statement">
                                            <RowStyle BackColor="White" HorizontalAlign="Center" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" />
                                            <Columns>
                                            
                                            <asp:BoundField DataField="Current_Bank_Statement" HeaderText="FileName" />
                                           <asp:TemplateField HeaderText="File Path">
                                           <ItemTemplate>
                                           <asp:ImageButton ImageUrl="~/Images/download.png" ID="lnkDownload" runat="server" Text="Download" ToolTip="Download File" OnClick="lnkDownload_Click" />
