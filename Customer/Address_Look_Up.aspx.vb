...
Partial Class Common_Files_Address_Look_Up
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Dim strScript = "<script>window.opener.document.forms['form1'].elements['txtsubr'].value" + " = '" + GridView1.Rows(row_index).Cells.Item(1).Text + "';"
        strScript += "window.opener.document.forms['form1'].elements['txtpstcoder'].value" + " = '" + GridView1.Rows(row_index).Cells.Item(0).Text + "'; "
        strScript += "window.opener.document.forms['form1'].elements['txtstater'].value" + " = '" + GridView1.Rows(row_index).Cells.Item(2).Text + "'; "
