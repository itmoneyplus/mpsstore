<%@ Page Language="VB" Culture="en-AU" EnableEventValidation="false" AutoEventWireup="false"
    CodeFile="Detail.aspx.vb" Inherits="Customer_Detail" MaintainScrollPositionOnPostback="false" %>
...
<body>
    ...
    <div>
        ...
        <table class="table" align="center">
            <tr>
                <td>
                    ...
                    <asp:LinkButton runat="server" ID="LinkButton_AddCustomer" Text="Add Customer" CssClass="link_text"
        ...
        <br />
        <br />
        <asp:Label ID="Label4" runat="server" CssClass="declined_label_text" Text="Customer Search Result"
    ...
    CellSpacing="2"  style="margin-left:30px;margin-top: 27px">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Time_Joined" HeaderText="Time_Joined" SortExpression="Time_Joined"
                    DataFormatString="{0:T}" HtmlEncode="false"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
            </Columns>
                ...
                <table cellspacing="0" cellpadding="0" width="98%"  >
                    ...
                    <td style="border:1px solid gray; width:82%;vertical-align :top">
                        ...
                        <br />
                                ...
                                <tool2:Toolbaar2 ID="tool2" runat="server" />                       
