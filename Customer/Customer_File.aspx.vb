...
Imports System
Imports System.Data
Partial Class Customer_Customer_File
    ...
    Function bind_grid() As Boolean
        Try
            ...
            str_document = " SELECT Current_Bank_Statement FROM Tbl_Customer where  customer_ID = " & open_con.customer_id_val
  ...
  Protected Sub lnkDownload_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            Dim filePath As String = GridView2.DataKeys(gvrow.RowIndex).Value.ToString()
            Response.AddHeader("Content-Disposition", "attachment;filename=""" & filePath & """")
            Response.TransmitFile("H:/WebSpace/cuykynsi/test1.moneyplus.com.au/wwwroot/uploads/" & filePath)
