<%@ Page Language="VB" Culture="en-AU" AutoEventWireup="false" CodeFile="Bank_File_CBA.aspx.vb"
    Inherits="Customer_Bank_File_CBA" %>
            ...
            <td align="left">
                <ul id="navbarBankFile">
                  ...
                  <asp:LinkButton ID="Link_Till" runat="server" CssClass="toolbaar1_link" PostBackUrl="~/Customer/Update_Till.aspx"
                    ...
                    TabIndex="5" Font-Bold="True" ForeColor="#2E95C9">CBA Debit</asp:LinkButton>
    ...
    <%--<br />--%>
            <table align="left" class="w100">
                         <tr>
                            ...
                            <p>
                            &nbsp;&nbsp;<img alt="Logo" src="../Images/cba_mainLogo.gif" width="40" height="60" />&nbsp; <b>CBA Debit File</b></p>
                            </td>
                        </tr> 
                        <tr>
                            ...
                            <td>
                                 <ajaxToolkit:ToolkitScriptManager runat="Server" EnableScriptGlobalization="true"
                                    ...
                                    <asp:TextBox ID="Txt_date_cba" runat="server"  style="width:100px;margin-bottom:20px; " CssClass="align-center_teller"></asp:TextBox>
                                    <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="Txt_date_cba"
                        ...
                        <tr>
                            <td></td>
                            <td>
                             <asp:Button ID="Btn_cba" runat="server" Text="Create Customer List for CBA Debit File" CssClass="btn_BankFile" />
                        ...
                        <tr>
                            <td colspan="3" valign="top">
                                ...
                                <asp:GridView ID="GridView1" runat="server" 
                                    AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" PageSize="5" 
                                    BorderStyle="Solid" BorderWidth="1px" CellPadding="4" Font-Size="14px" 
                                    ForeColor="Black" RowHeaderColumn="Customer Id" Width="90%" 
                                    CellSpacing="2"  style="margin-top: 20px" ShowFooter="True" >
                        ...
                        <tr>
                            <td colspan="3" style="text-align: center;">
                                <br />
                                       <asp:Button ID="cancel_cba" runat="server" Text="Cancel & go back" Visible="false"
                                            CssClass="align_mid" />&nbsp;&nbsp;
                                        <asp:Button ID="debit_cba" runat="server" Text="Create Debit file" Visible="false"
                                            CssClass="align_mid" OnClientClick="Confirm();" />&nbsp;&nbsp;
                                        <asp:Button ID="cba_print" runat="server" Text="View & Print" Visible="false" CssClass="align_mid" />
                                 <br />
                                <br />
                            </td>
                        </tr>
                            ...
                            <td colspan="3" style="text-align: center;">
                                 <br />
                                    ...
                                    <td class="align-center">
                                        <asp:Label ID="Label_cba" runat="server"  CssClass ="rptHead_new " Text="List CBA Debit Files:"  ></asp:Label>
                                    </td>
                                    </tr>
                                    <tr>
                                    <td class="align-center" >
                                   
                                    <asp:GridView ID="GridView_cba" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" 
                                    BorderStyle="Solid" BorderWidth="1px" CellPadding="4" Font-Size="14px" AllowPaging="True"  PageSize="10"   AllowSorting="False"  
                                    ForeColor="Black" RowHeaderColumn="Customer Id"  
                                    CellSpacing="2"   style="margin-bottom: 0px" 
                                    Width="50%" DataKeyNames ="Name_CBA_Files">
                                     <RowStyle BackColor="White" HorizontalAlign="Left" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" />
                                    <Columns>
                                    
                                   <asp:BoundField DataField="Name_CBA_Files" HeaderText="File Name"   />
                                        <asp:BoundField DataField="Date_Created" HeaderText="Date Created"   />
                                   <asp:TemplateField HeaderText="File Path">
                                   <ItemTemplate>
                                    <asp:ImageButton ImageUrl="~/Images/download.png" ID="lnkDownload_cba" runat="server" Text="Download" ToolTip="Download CBA File"  OnClick="lnkDownload_Click"   />
