<%@ Page Language="VB" Culture="en-AU" AutoEventWireup="false" CodeFile="Customer_PayrollDue.aspx.vb" Inherits="Customer_Customer_PayrollDue" %>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                            <tr class="toolbaar1_tr">
                                <td class="toolbaar1_td_rep">
                                    <asp:LinkButton ID="Link_payroll_due" runat="server"  CssClass="toolbaar1_link_active" PostBackUrl="~/Customer/Customer_PayrollDue.aspx" TabIndex="1" >Payroll Deduction Due</asp:LinkButton>
                                </td>
                            </tr>                          
                            <tr>
                                <td>
    ...
    <br />
        <table align="left" class="w100">
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <asp:Button ID="Button1" runat="server" Text="Reterive Salary Deductions Due Report" CssClass="btn"/>
                        ...
                        <tr>
                            <td colspan="3" style="text-align: center;">
                                       <asp:Button ID="btnduepay" runat="server"  Text="Record Payment"  Visible="false" 
                                               style="height: 26px" />&nbsp;&nbsp;&nbsp;
                                       <asp:Button ID="btndueviewpay" runat="server"  Text="View & Print" Visible="false"  />
                                <br />
                                <br />
                            </td>
                        </tr>
