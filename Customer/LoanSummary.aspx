<%@ Page Language="VB"  Culture="en-AU"  EnableEventValidation="false" AutoEventWireup="false" CodeFile="LoanSummary.aspx.vb" Inherits="Customer_LoanSummary" maintainScrollPositionOnPostBack="false"  %>
<%@ Register Src="~/toolbaar/tool_main.ascx"  TagName="Toolbaar1"   TagPrefix="tool1"%>
<%@ Register Src="~/toolbaar/NominateBSB.ascx" TagName="Toolbaar5"  TagPrefix="tool5"%>
<%@ Register Src="~/toolbaar/NominateBank.ascx" TagName="Toolbaar100"  TagPrefix="tool100"%>
<%@ Register Src="~/toolbaar/tool.ascx" TagName="Toolbaar3"  TagPrefix="tool3"%>
<%@ Register Src="~/toolbaar/loansum.ascx" TagName="Toolbaar6"  TagPrefix="tool6"%>
<%@ Register Src="~/toolbaar/loanrepay.ascx" TagName="Toolbaar7"  TagPrefix="tool7"%>
<%@ Register Src="~/toolbaar/letter.ascx" TagName="Toolbaar8"  TagPrefix="tool8"%>
<%@ Register Src="~/toolbaar/RescheduleHistory.ascx" TagName="Toolbaar9"  TagPrefix="tool9"%>
<%@ Register src="~/toolbaar/AccountStatement.ascx" TagName ="Toolbaar10" TagPrefix ="tool10" %>
<%@ Register Src="~/toolbaar/Pay_Receipt.ascx" TagName="Toolbaar11"  TagPrefix="tool11"%>
<%@ Register Src="~/toolbaar/Pay_Sch.ascx" TagName="Toolbaar12"  TagPrefix="tool12"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <link rel="stylesheet" type="text/css" href="../css/menu.css" />
     ...
     <script type = "text/javascript"  language="JavaScript">
         ...
         function Confirm() {
             ...
             if (confirm("Click OK to Approve or click Cancel to go back!")) {
                 confirm_value.setAttribute("type", "hidden");
                 confirm_value.setAttribute("value", "Yes");
                 confirm_value.setAttribute("name", "confirm_value");
             } else {
             confirm_value.setAttribute("type", "hidden");
             confirm_value.setAttribute("value", "No");
             confirm_value.setAttribute("name", "confirm_value");
             }
             document.forms[0].appendChild(confirm_value);
         }
         function Decline() {
             var confirm_value_dec = document.createElement("INPUT");

             if (confirm("Click OK to Decline or click Cancel to go back!")) {
                 confirm_value_dec.setAttribute("type", "hidden");
                 confirm_value_dec.setAttribute("value", "Yes");
                 confirm_value_dec.setAttribute("name", "confirm_value_dec");
                 
             } else {
             confirm_value_dec.setAttribute("type", "hidden");
             confirm_value_dec.setAttribute("value", "No");
             confirm_value_dec.setAttribute("name", "confirm_value_dec");
             }
             document.forms[0].appendChild(confirm_value_dec);
         }
    ...
    <asp:Button ID="btnsearch" runat="server"  Text ="Search" TabIndex="9"  />
    ...
    <asp:BoundField DataField="Date_Of_Birth" HeaderText="Date Of Birth" SortExpression="Date Of Birth" DataFormatString="{0:d-MMM-yyyy}"  HtmlEncode="false"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
    <asp:BoundField DataField="Request_Amount" HeaderText="Request Amount" 
    DataFormatString="{0:c}"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
    <asp:BoundField DataField="Date_Joined" HeaderText="Date Joined"  SortExpression="Date Joined" DataFormatString="{0:d}"  HtmlEncode="false"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
    <asp:BoundField DataField="Time_Joined" HeaderText="Time_Joined"  SortExpression="Time_Joined" DataFormatString="{0:T}"  HtmlEncode="false"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
    ...
    <asp:Panel ID="Panel111" runat="server" CssClass="customerContent">
                    ...
                    <td style="border:1px solid gray; width:82%;vertical-align :top">
                        ...
                        <br />
                                 <asp:Panel ID="Panel2" runat="server">  
                                        <tool6:Toolbaar6 ID="tool_6" runat ="server" />
                                        <br /> 
                                        <div class="align-center">
                                        <asp:Button ID="btnloanrepay" runat="server" Text="Loan Repayment"  Width="120px" 
                                                CssClass ="td_ht" TabIndex="1"/>&nbsp;&nbsp;
                                        <asp:Button ID="btnprntcntrct" runat="server" Text="Print Contract" Width="100px" CssClass ="td_ht" />&nbsp;&nbsp;
                                        <asp:Button ID="btnprtcntrct" runat="server" Text="Part Contract" Width="120px" CssClass ="td_ht"/>&nbsp;&nbsp;
                                        <asp:Button ID="btnnabdd" runat="server" Text="NAB DD" Width="70px" CssClass ="td_ht"/>&nbsp;&nbsp;
                                        <asp:Button ID="btncbadd" runat="server" Text="CBA DD" Width="70px" CssClass ="td_ht"/>&nbsp;&nbsp;
                                        <asp:Button ID="btnpayroll" runat="server" Text="Payroll"  Width="60px" CssClass ="td_ht" /> &nbsp;&nbsp;
                                        <asp:Button ID="btnpayschedule" runat="server" Text="Payment Schedule" Width="130px" CssClass ="td_ht" />&nbsp;&nbsp;
                                         <asp:Button ID="btnschhistory" runat="server" Text="Schedule History"  Width="120px" CssClass ="td_ht"/><br/><br />
                                          <asp:Button ID="btnpaymentreceipt" runat="server" Text="Payment Receipt"  Width="120px" CssClass ="td_ht"/>&nbsp;&nbsp;
                                        <asp:Button ID="btnletter" runat="server" Text="Letters"  Width="60px" CssClass ="td_ht"/>&nbsp;&nbsp;
                                        <asp:Button ID="btnnominatebsb" runat="server" Text="Nominate BSB" Width="110px" CssClass ="td_ht" />&nbsp;&nbsp;
                                        <asp:Button ID="btnloanst" runat="server" Text="Statement of Loan" Width="130px" CssClass ="td_ht" />&nbsp;&nbsp;
                                        </div>  
                                        <br />
                                        <div class="align-center">
                                        <asp:Button ID="btnapprove" runat="server" Text="Approve" OnClientClick="Confirm()" />
                                        <asp:Button ID="btndecline" runat="server" Text="Decline"  OnClientClick ="Decline()"/>
                                        <br/>
                                        <br/>
                                        </div> 
                                        </asp:Panel>
                                        <asp:Panel ID="Panel1" runat="server" >
                                        <tool100:Toolbaar100  ID="tool_100" runat="server"/>
                                        <br />
                                        <%--<tool5:Toolbaar5  ID="tool_5" runat="server"/>--%></asp:Panel>
                                        <div class="align-center">
                                        <asp:Label ID="Label5" runat="server" Text="Loan Declined" CssClass ="font" Visible="false" ></asp:Label>
                                        </div>
                                        <asp:Panel ID="Panel3" runat="server"  >
                                        <tool7:Toolbaar7  ID="tool_7" runat ="server" /> 
                                        </asp:Panel>
                                        <asp:Panel ID="Panel4" runat="server" Visible ="false">
                                        <tool8:Toolbaar8 ID="tool_8" runat ="server"  /> 
                                        </asp:Panel>
                                        <asp:Panel ID="Panel5" runat="server" Visible ="false">
                                        <tool9:Toolbaar9 ID="tool_9" runat ="server" />
                                        </asp:Panel>
                                        <asp:Panel ID="Panel6" runat="server" Visible ="false">
                                        <tool10:Toolbaar10 ID="tool_10" runat="server" />
                                        </asp:Panel>
                                         <asp:Panel ID="Panel7" runat="server" Visible ="false">
                                        <tool11:Toolbaar11 ID="tool_11" runat="server"/>
                                        </asp:Panel>
                                         <asp:Panel ID="Panel8" runat="server" Visible ="false">
                                        <tool12:Toolbaar12 ID="tool_12" runat="server"/>
                                        <br />
                                        </asp:Panel>   
