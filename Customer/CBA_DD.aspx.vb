...
Partial Class Customer_CBA_DD
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            For i As Integer = 0 To ds_CustomerBank.Tables(0).Rows.Count - 1
                ...
                Response.Write("<div text-align:center>")
                ...
                Response.Write("<b style='font-size:16.5px'>Direct Debit Request (CBA)</b>")
                Response.Write("</td>")
                ...
                Response.Write("<br/>")
                Response.Write("Tel: " & ds_MoneyPlus.Tables(0).Rows(i).Item("Phone_Number").ToString)
                ...
                Response.Write(ds_CustomerBank.Tables(0).Rows(i).Item("Last_Name").ToString)
                Response.Write("<br/>")
                Response.Write("<br/>")
                Response.Write("<b style='font-size:16.5px'>Given name: &nbsp;</b>")
                Response.Write(ds_CustomerBank.Tables(0).Rows(i).Item("Given_Name").ToString)
                ...
                Response.Write("(User ID Number:" & ds_MoneyPlus.Tables(0).Rows(i).Item("CBA_User_ID1").ToString)
                ...
                Response.Write("<b>Financial institution name </b>" & ds_CustomerBank.Tables(0).Rows(i).Item("Bank_Name").ToString)
                Response.Write("<br/>")
                Response.Write("<br/>")
                Response.Write("<b style='font-size:16.5px'>Address: </b>" & ds_CustomerBank.Tables(0).Rows(i).Item("Bank_Address").ToString)
                Response.Write("<br/>")
                Response.Write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;")
                Response.Write(ds_CustomerBank.Tables(0).Rows(i).Item("Bank_Suburb").ToString & " " & ds_CustomerBank.Tables(0).Rows(i).Item("Bank_State").ToString & " " & ds_CustomerBank.Tables(0).Rows(i).Item("Bank_Post_Code").ToString)
                Response.Write("</td>")
                Response.Write("</tr>")
                Response.Write("<tr>")
                Response.Write("<td valign='top' style='font-size:16.5px;width:240; border-left: 1.0pt solid windowtext; border-right: 1.0pt solid windowtext; border-top: medium none; border-bottom: 1.0pt solid windowtext; padding-left: 5.4pt; padding-right: 5.4pt; padding-top: 0in; padding-bottom: 0in; height:83'>")

                Response.Write("<b style='font-size:16.5px'>Insert details of account to be debited</b>")
                Response.Write("</td>")
                Response.Write("<td colspan='2' valign='top' style='font-size:16.5px;width:650; border-left: medium none; border-right: 1.0pt solid windowtext; border-top: medium none; border-bottom: 1.0pt solid windowtext; padding-left: 5.4pt; padding-right: 5.4pt; padding-top: 0in; padding-bottom: 0in;height:83'>")

                Response.Write("<b style='font-size:16.5px'>Name of account </b>" & ds_CustomerBank.Tables(0).Rows(i).Item("Account_Name").ToString)
                Response.Write("<br/>")
                Response.Write("<b style='font-size:16.5px'>BSB number</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & ds_CustomerBank.Tables(0).Rows(i).Item("BSB").ToString)
                Response.Write("<br/>")
                Response.Write("<b style='font-size:16.5px'>Account number </b>" & ds_CustomerBank.Tables(0).Rows(i).Item("Account_Number").ToString)
                ...
                Dim cba_amt As Double
                Dim cba_amt_new As String
                Dim cba_date As DateTime
                Dim cba_date_new As String
                ...
                ElseIf ds_schedule.Tables(0).Rows.Count = 1 Then
                    ...
                    For j As Integer = 0 To (int_ScheduleTotal / 2) - 1
                        ...
                        cba_amt = ds_schedule.Tables(0).Rows(j).Item("Amount").ToString()
                        cba_amt = open_con.check_amount_format(Math.Round(cba_amt, 2))
                        cba_amt_new = open_con.new_amount(cba_amt)
                        Response.Write(cba_amt_new)
                        Response.Write("&nbsp;&nbsp;&nbsp;&nbsp;")
                        cba_date = ds_schedule.Tables(0).Rows(j).Item("Due_Date").ToString()
                        cba_date_new = cba_date.ToString("dd/MM/yyyy")
                        Response.Write(cba_date_new)
                ...
                ElseIf int_ScheduleTotal Mod 2 = 0 Then
                    ...
                    For k As Integer = (int_ScheduleTotal / 2) To int_ScheduleTotal - 1
                        ...
                        cba_amt = ds_schedule.Tables(0).Rows(k).Item("Amount").ToString()
                        cba_amt = open_con.check_amount_format(Math.Round(cba_amt, 2))
                        cba_amt_new = open_con.new_amount(cba_amt)
                        Response.Write(cba_amt_new)
                        Response.Write("&nbsp;&nbsp;&nbsp;&nbsp;")
                        cba_date = ds_schedule.Tables(0).Rows(k).Item("Due_Date").ToString()
                        cba_date_new = cba_date.ToString("dd/MM/yyyy")
                        Response.Write(cba_date_new)
                        Response.Write("<br/>")
                    Next
                ...
                Response.Write("<br/>")
                Response.Write("<br/>")
                Response.Write("<b style='font-size:16.5px'>Address</b> " & ds_CustomerBank.Tables(0).Rows(i).Item("Street_Number").ToString & " " & ds_CustomerBank.Tables(0).Rows(i).Item("Street_Name").ToString & ", " & ds_CustomerBank.Tables(0).Rows(i).Item("Suburb").ToString & " " & ds_CustomerBank.Tables(0).Rows(i).Item("State").ToString & " " & ds_CustomerBank.Tables(0).Rows(i).Item("Post_Code").ToString)
                Response.Write("<br/>")
                Response.Write("<br/>")
