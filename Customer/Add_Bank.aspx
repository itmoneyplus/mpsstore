<%@ Page Language="VB" Culture="en-AU" EnableEventValidation ="false"  AutoEventWireup="false" CodeFile="Add_Bank.aspx.vb" Inherits="Customer_Add_Bank" %>
    ...
    <asp:Panel ID="Panel2" runat="server" CssClass="customerContent">
                ...
                <table cellspacing="0" cellpadding="0" width="98%"  >
                    ...
                    <td style="border:1px solid gray; width:82%;vertical-align :top">
                        <div align="left">
                        <br />
                               <asp:Panel ID="Panel1" runat="server" class="tool_chequesummary_layout">
                                         <div  align="center" >
                                         <table cellpadding="3" class="table_loanrepay2" >
                                         <tr>
                                         <td  class="td" colspan="4"  ><b>BSB &amp; Account No.</b></td>
                                         </tr>
                                         <tr>
                                         <td class="td"><img src="../Images/White_Right_Arrow.GIF" alt="" style="margin-left:60px;" /> Bank name:</td>
                                         <td>
                                         <asp:TextBox ID="txtBankName" runat="server" TabIndex ="11"   Height="17px"  Width="218px" MaxLength="45" ></asp:TextBox></td>
                                         <td class="td"><img src="../Images/White_Right_Arrow.GIF" alt="" style="margin-left:60px;" /> Bank address:</td>
                                         <td class="td">
                                         <asp:TextBox ID="txtBankAddress" runat="server" TabIndex ="12"  Height="17px"  Width="223px" MaxLength="45" ></asp:TextBox></td>
                                         </tr>
                                         <tr>
                                         <td class="td" ><img src="../Images/White_Right_Arrow.GIF" alt="" style="margin-left:60px;" /> BSB:</td>
                                         <td class="td">
                                         ...
                                         <input type="button" onclick="getbsb()" style="background-image: url('../Images/Lookup.gif'); background-color:Transparent;background-repeat:no-repeat; height: 19px; width: 20px; border :none"  />
                                         </td>
                                         <td class="td"><img src="../Images/White_Right_Arrow.GIF" alt="" style="margin-left:60px;" /> Suburb:</td>
                                         <td class="td">
                                         <asp:TextBox ID="txtBankSuburb"  runat="server" TabIndex ="14"  Height="17px"  Width="146px" MaxLength="25" ></asp:TextBox></td>
                                         </tr>
                                         <tr>
                                         <td class="td"><img src="../Images/White_Right_Arrow.GIF" alt="" style="margin-left:60px;" /> Account number:</td>
                                         <td class="td"><asp:TextBox ID="txtAccountNumber"   runat="server" TabIndex ="15"  CssClass="align"  Height="17px"  Width="109px" MaxLength="15" ></asp:TextBox></td>
                                         <td class="td"><img src="../Images/White_Right_Arrow.GIF" alt="" style="margin-left:60px;" /> State:</td>
                                         <td class="td"><asp:TextBox ID="txtBankState"  runat="server" TabIndex ="16"   Height="17px"  Width="61px" MaxLength="3" ></asp:TextBox></td>
                                         </tr>
                                         <tr>
                                         <td class="td" ><img src="../Images/White_Right_Arrow.GIF" alt="" style="margin-left:60px;" /> Account name:</td>
                                         <td class="td">
                                         ...
                                         <td class="td"><img src="../Images/White_Right_Arrow.GIF" alt="" style="margin-left:60px;" /> Post code:</td>
                                         <td class="td"><asp:TextBox ID="txtBankPostCode"  runat="server" TabIndex ="18"   Height="17px"  Width="54px" MaxLength="4" ></asp:TextBox></td>
                                         <td class="td"></td></tr>
                                         <tr>
                                         <td class="align-center"  colspan ="4">
                                         <asp:Button ID="goback" runat="server" Text="GoBack" TabIndex="19"  />
                                         <asp:Button ID="updatebankdetail" runat="server" Text="Update Bank Detail" TabIndex="20"/>
                                         <asp:Button ID="printbnkdet" runat="server" Text="Print Detail" TabIndex="21"/>
                                         </td>
                                         </tr>
                                         </table>
                                         </div>
