...
Partial Class Customer_loan_stats
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            ElseIf txtsearch.Text = "" And Request.QueryString("Amt") <> "" Then
                Panel1.Visible = True
                Label4.Visible = True
    ...
    Sub binddata_grid2_()
        ...
        Dim amt_grid2, fromdt_grid2, todt_grid2 As String
        Dim fromdt_grid2_new, todt_grid2_new As String
        If Request.QueryString("Amt") <> "" And Request.QueryString("Amt_VL") <> 0 Then
            btn_print.Visible = True
            amt_grid2 = Request.QueryString("Amt") & ".00"
            Session("amt_grid2") = amt_grid2
            ...
            Label4.Text = "Loans Statistics Report for " & "$" & amt_grid2 & "  for the period " & fromdt_grid2_new & " to " & todt_grid2_new
            str_SQL_grid2 = "Select * from tbl_Loan,tbl_customer where Amount='" & amt_grid2 & "' and tbl_loan.status<>0 and tbl_loan.status<>2  and Loan_Date>= ' " & fromdt_grid2 & "' and Loan_Date<= ' " & todt_grid2 & "' and tbl_loan.customer_id=tbl_customer.customer_id"
        ...
        ElseIf Request.QueryString("Amt_VL") = 0 Or Request.QueryString("Amt") = 0 Then
            Label5.Visible = True
            btn_print.Visible = False
            amt_grid2 = Request.QueryString("Amt") & ".00"
            fromdt_grid2 = Request.QueryString("From_Dt")
    ...
    Protected Sub btn_print_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_print.Click
        Response.Redirect("../Reports/Print_loan_stats.aspx")
    End Sub
End Class
