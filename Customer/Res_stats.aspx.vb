...
Imports System
Imports System.Data
Partial Class Customer_loan_stats
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            ElseIf txtsearch.Text = "" And Request.QueryString("Res_Type") <> "" Then
                Panel1.Visible = True
                Label4.Visible = True
    ...
    End Sub
    Sub binddata_grid2_()
        Dim cmd_grid2 As New SqlCommand
        Dim adap_grid2 As SqlDataAdapter
        Dim ds_grid2 As New DataSet
        Dim str_SQL_grid2 As String
        Dim res_grid2, fromdt_grid2, todt_grid2 As String
        Dim fromdt_grid2_new, todt_grid2_new As String
        If Request.QueryString("Res_Type") <> "" And Request.QueryString("Res_VL") <> 0 And Request.QueryString("Res_type") <> "Other" Then
            btn_print.Visible = True
            res_grid2 = Request.QueryString("Res_Type")
            Session("res_grid2") = res_grid2
            fromdt_grid2 = Request.QueryString("From_Dt")
            Session("fromdt_grid2") = fromdt_grid2
            todt_grid2 = Request.QueryString("To_Dt")
            Session("todt_grid2") = todt_grid2
            ...
            Label4.Text = "Residential Statistics Report for the period " & fromdt_grid2_new & " to " & todt_grid2_new
            str_SQL_grid2 = "Select * from tbl_Loan,tbl_customer where Residential_Status='" & res_grid2 & "' and tbl_loan.status<>0 and tbl_loan.status<>2  and Loan_Date>= ' " & fromdt_grid2 & "' and Loan_Date<= ' " & todt_grid2 & "' and tbl_loan.customer_id=tbl_customer.customer_id"
            cmd_grid2.Connection = open_con.return_con
            cmd_grid2.CommandText = str_SQL_grid2
            cmd_grid2.ExecuteNonQuery()

            adap_grid2 = New SqlDataAdapter(cmd_grid2)
        ...
        ElseIf Request.QueryString("Res_type") = "Other" Then
            ...
            todt_grid2_new = todt_grid2_new.Replace("-", " ")
            Label4.Text = "Residential Statistics Report for the period " & fromdt_grid2_new & " to " & todt_grid2_new
            str_SQL_grid2 = "Select * from tbl_Loan,tbl_customer where Residential_Status<>'Own' and Residential_Status<>'Mortgage' and Residential_Status<>'Boarding'  and Residential_Status<>'Rent' and tbl_loan.status<>0 and tbl_loan.status<>2  and Loan_Date>= ' " & fromdt_grid2 & "' and Loan_Date<= ' " & todt_grid2 & "' and tbl_loan.customer_id=tbl_customer.customer_id"
            cmd_grid2.Connection = open_con.return_con
            cmd_grid2.CommandText = str_SQL_grid2
            cmd_grid2.ExecuteNonQuery()
        ...
        ElseIf Request.QueryString("Res_VL") = 0 Or Request.QueryString("Res_type") = "" Then
            Label5.Visible = True
            btn_print.Visible = False
            fromdt_grid2 = Request.QueryString("From_Dt")
            todt_grid2 = Request.QueryString("To_Dt")
    ...
    Protected Sub btn_print_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_print.Click
        Response.Redirect("../Reports/Print_Res_Status.aspx")
    End Sub
End Class
