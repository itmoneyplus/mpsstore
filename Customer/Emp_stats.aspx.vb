...
Partial Class Customer_loan_stats
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            ElseIf txtsearch.Text = "" And Request.QueryString("Emp_Type") <> "" Then
                Panel1.Visible = True
                Label4.Visible = True
    ...
    Sub binddata_grid2_()
        ...
        Dim emp_grid2, fromdt_grid2, todt_grid2 As String
        Dim fromdt_grid2_new, todt_grid2_new As String
        If Request.QueryString("Emp_Type") <> "" And Request.QueryString("Emp_VL") <> 0 And Request.QueryString("Emp_type") <> "Other" Then
            btn_print.Visible = True
            emp_grid2 = Request.QueryString("Emp_Type")
            Session("emp_grid2") = emp_grid2
            ...
            Label4.Text = "Employment Statistics Report for the period " & fromdt_grid2_new & " to " & todt_grid2_new
            str_SQL_grid2 = "Select * from tbl_Loan,tbl_customer where Emp_Status='" & emp_grid2 & "' and tbl_loan.status<>0 and tbl_loan.status<>2  and Loan_Date>= ' " & fromdt_grid2 & "' and Loan_Date<= ' " & todt_grid2 & "' and tbl_loan.customer_id=tbl_customer.customer_id"
        ...
        ElseIf Request.QueryString("Emp_type") = "Other" Then
            ...
            todt_grid2_new = todt_grid2_new.Replace("-", " ")
            Label4.Text = "Employment Statistics Report for the period " & fromdt_grid2_new & " to " & todt_grid2_new
            str_SQL_grid2 = "Select * from tbl_Loan,tbl_customer where Emp_Status<>'Permanent' and Emp_Status<>'Part Time' and Emp_Status<>'Casual' and tbl_loan.status<>0 and tbl_loan.status<>2  and Loan_Date>= ' " & fromdt_grid2 & "' and Loan_Date<= ' " & todt_grid2 & "' and tbl_loan.customer_id=tbl_customer.customer_id"
            cmd_grid2.Connection = open_con.return_con
            cmd_grid2.CommandText = str_SQL_grid2
            cmd_grid2.ExecuteNonQuery()
        ...
        ElseIf Request.QueryString("Emp_VL") = 0 Or Request.QueryString("Emp_type") = "" Then
            Label5.Visible = True
            btn_print.Visible = False
            fromdt_grid2 = Request.QueryString("From_Dt")
            todt_grid2 = Request.QueryString("To_Dt")
    ...
    Protected Sub btn_print_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_print.Click
        Response.Redirect("../Reports/Print_Emp_Status.aspx")
    End Sub
End Class
