<%@ Page Language="VB" Culture="en-AU" AutoEventWireup="false" CodeFile="Personal_Form.aspx.vb" Inherits="Customer_Personal_Form"  %>
        ...
        <tr>
            <td align="left">
                <ul id="navbarOnlineJoined">
                    ...
                    <li>
                         <asp:LinkButton ID ="lnkbtnPersonalform" runat="server"  TabIndex="1" Font-Bold="True" 
                            ForeColor="#2E95C9"  PostBackUrl="~/Customer/Personal_Form.aspx">Add New Customer</asp:LinkButton>
                        ...
                        *         
                        ...
                        <%--    ............................................................................--%>
	                            ...
	                            *</td> 
                                 ...
                                 <td class="td-personal">                		                		
                              <%--       <asp:TextBox ID="txtdtbirth" runat="server" Width ="130px" MaxLength="10" 
                             ...
                             *</td>
    	                        ...
    	                        <td  class="td-personal" >
                                <asp:TextBox ID="txtEmail" runat ="server" Width ="190px" MaxLength="40" TabIndex="20"  ></asp:TextBox>*</td> 
                                </tr><tr>
	                           ...
	                           <tr>
                                ...
                                <asp:RadioButton ID="RadioButton1" Text ="Driver's Licence" runat="server" CssClass="td-personal" AutoPostBack="True" Checked="True" TabIndex="24"  />  
                               <asp:RadioButton ID="RadioButton2" Text ="Passport Number" runat="server" CssClass="td-personal" AutoPostBack="True" TabIndex="25"  /> </td></tr>
                               <tr>		 
                               ...
                               <asp:TextBox runat="server" ID="txtPassport" Width="150px" MaxLength="10"  TabIndex="27"></asp:TextBox></td>
                                ...
                                <td class="td-personal">	
                                <asp:TextBox runat="server" ID="txtLicence_card_no" width="150px"  MaxLength="10" TabIndex="28"></asp:TextBox> </td>
 	                            ...
 	                            <tr>
      	                        ...
      	                        <td class="td-personal">
                                <asp:DropDownList ID="drop6" runat ="server" TabIndex="30"  >
                                <asp:ListItem ></asp:ListItem>
		                        ...
		                        <asp:ListItem >WA</asp:ListItem >
                                  ...
                                  <td class="td-personal"> 
                                  <asp:TextBox  ID ="txtunitnor"  Width="55px" runat="server" MaxLength="8" TabIndex="32" ></asp:TextBox> </td>
                                 <td  class="td-personal">Unit number:</td>
                                 <td  class="td-personal"> 
                                 <asp:TextBox  ID ="txtunitnom"  Width="55px" runat="server" MaxLength="8" TabIndex="33" ></asp:TextBox> </td>
                                 </tr>    		
                                <tr>
                                <td  class="td-personal">Street number:</td>
                                <td class="td-personal"> 
                                <asp:TextBox  ID ="txtstrtnor"  Width="55px" runat="server" MaxLength="8" TabIndex="34" ></asp:TextBox> 
                                </td>
                             	
                                <td  class="td-personal">Street number:</td>
                                <td  class="td-personal">
                                <asp:TextBox  ID ="txtstrtnom"  Width="55px" runat="server" MaxLength="8" TabIndex="35" ></asp:TextBox> </td>
                                </tr>  
                                    		
                                <tr>
  		                        <td  class="td-personal">Street name:</td>
                                <td class="td-personal"> 
                                <asp:TextBox  ID ="txtstrtnmr"  Width="165px" runat="server" MaxLength="60"  TabIndex="36" ></asp:TextBox> 
                               </td>
                         	
                                <td  class="td-personal">Street name:</td>
                                <td  class="td-personal">
                                <asp:TextBox  ID ="txtstrtnmm"  Width="165px" runat="server" MaxLength="60"  TabIndex="37" ></asp:TextBox> </td>
                                </tr>  
                                    		
                                <tr>
  		                        <td  class="td-personal">Suburb:</td>
                                <td class="td-personal"> 
                                <asp:TextBox  ID ="txtsubr"  Width="170px" runat="server" MaxLength="25"  TabIndex="38" ></asp:TextBox> 
                                <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Images/Lookup.gif" style="width: 19px; height: 17px;" OnClientClick ="getpage_add()"  />
                                </td>

                               <td  class="td-personal">Suburb:</td>
                               <td  class="td-personal">
                               <asp:TextBox  ID ="txtsubm"  Width="180px" runat="server" MaxLength="25"  TabIndex="39" ></asp:TextBox> 
                               <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/Images/Lookup.gif" OnClientClick ="getpage_m_add()" />
                               </td>
                               </tr>  
                                ...
                                <td class="td-personal"> 
                                <asp:TextBox  ID ="txtpstcoder"  Width="55px" runat="server" MaxLength="4" TabIndex="40" ></asp:TextBox> 
                                <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Images/Lookup.gif" OnClientClick ="getpage_add()" />
                                </td>

                                <td  class="td-personal">Postcode:</td>
                                <td  class="td-personal">
                                <asp:TextBox  ID ="txtpstcodem"  Width="55px" runat="server" MaxLength="4" TabIndex="41" ></asp:TextBox> 
                                <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/Images/Lookup.gif" OnClientClick ="getpage_m_add()" style="width: 19px" />
                                </td>
                                </tr>  
                                ...
                                <td class="td-personal"> 
                                <asp:TextBox  ID ="txtstater"  Width="55px" runat="server" MaxLength="3" TabIndex="42" ></asp:TextBox> 
                                </td>

                                <td  class="td-personal">State:</td>
                                <td  class="td-personal">
                                <asp:TextBox  ID ="txtstatem"  Width="55px" runat="server" MaxLength="3" TabIndex="43" ></asp:TextBox> </td>
                                </tr>  
                                <tr>
                                <td colspan="4" >
                                <hr style ="color :#C0C0C0 ; size:1px ;height: -15px"/></td>
                        ...
                        <%--................................................................--%>
                                ...
                                <td class="td-personal"> 
                               <asp:DropDownList ID="drop8" runat="server" Width ="100px" TabIndex="44">
                               <asp:ListItem ></asp:ListItem>
                               ...
                               *</td>
                               ...
                               <td class="td-personal"> 
                               <asp:TextBox  ID ="txtcmpnmemp"  Width="190px" runat="server" MaxLength="60" CssClass="txtbox" TabIndex="45" ></asp:TextBox> *</td>
                                </tr>  
                                <tr>
  		                        <td  class="td-personal">Type&nbsp;of&nbsp;business:</td>
                                <td class="td-personal"> 
                                <asp:TextBox  ID ="txttypbus"  Width="165px" runat="server" MaxLength="60" CssClass="txtbox" TabIndex="46" ></asp:TextBox> 
                                </td>
                                <td  class="td-personal">Contact number:&nbsp;</td>
                                <td  class="td-personal"> 
                                <asp:TextBox  ID ="txtcnctnoemp"  Width="100px" runat="server" MaxLength="10" TabIndex="47" ></asp:TextBox> *</td>
                                </tr>  
                                <tr>
  		                        <td  class="td-personal">Suburb:</td>
                                <td class="td-personal"> 
                                <asp:TextBox  ID ="txtsub"  Width="150px" runat="server" MaxLength="25" CssClass="txtbox" TabIndex="48" ></asp:TextBox> 
                               </td>
                               <td  class="td-personal">Time&nbsp;with&nbsp;employer: </td>
                               <td  class="td-personal"> 
                               <asp:TextBox  ID ="txtyrs"  Width="30px" runat="server" MaxLength="2" TabIndex="49" ></asp:TextBox>Yrs
                               <asp:TextBox  ID ="txtmnths"  Width="30px" runat="server" MaxLength="2" Height="22px" TabIndex="50" ></asp:TextBox>Mths
                               </td>
                               </tr>  
                               <tr>
  	                           <td  class="td-personal">Position:</td>
                               <td class="td-personal"> 
                               <asp:TextBox  ID ="txtpos"  Width="200px" runat="server" MaxLength="25" CssClass="txtbox" TabIndex="51" ></asp:TextBox> 
                               </td>
                               <td  class="td-personal">Income:</td>
                               <td  class="td-personal"> 
                               <asp:TextBox  ID ="txtinc"  Width="75px" runat="server" MaxLength="4" TabIndex="52" ></asp:TextBox> (A$ Net Fortnightly)* </td>
                                </tr>  
                                <tr>
                                <td colspan="4" >
                                <hr style ="color :#C0C0C0 ; size:1px ;height: -15px"/></td>
                                ...
                                <td class="td-personal"> 
                                <asp:DropDownList ID="drop9" runat="server" Width ="100px" TabIndex="53">
                                <asp:ListItem ></asp:ListItem>
                                ...
                                <tr>
  		                        <td  class="td-personal" >Company name:&nbsp;</td>
                                <td class="td-personal"> 
                                <asp:TextBox  ID ="txtcmpnmres"  Width="185px" runat="server" MaxLength="60" CssClass="txtbox" TabIndex="54" ></asp:TextBox> 
                               
                                *</td>

                                <td  class="td-personal">Contact number:&nbsp;</td>
                                <td  class="td-personal"> 
                                <asp:TextBox  ID ="txtcnctres"  Width="120px" runat="server" MaxLength="10" TabIndex="55" CssClass="txtbox"></asp:TextBox> *</td>
                                </tr>           
                                <tr>
                                <td colspan="4" >
                                <hr style ="color :#C0C0C0 ; size:1px ;height: -15px"/></td>
                                ...
                                <tr> 
                                <td class="align_width"> </td>
                                <td class="align_width"> </td>
                                <td class="align_width">
                                <asp:Button ID="Save_btn" runat="server" Text="Save"  Width ="70px" TabIndex="56"  />
                                <br />
                                <br />
                                </td>
                                <td class="align_width"></td>
