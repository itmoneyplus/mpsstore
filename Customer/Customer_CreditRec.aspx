<%@ Page Language="VB" Culture="en-AU" AutoEventWireup="false" CodeFile="Customer_CreditRec.aspx.vb" Inherits="Customer_Customer_CreditRec" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register Src="~/toolbaar/tool_main.ascx" TagName="Toolbaar1"   TagPrefix="tool1"%>
<%@ Register Src="~/toolbaar/Customer_cre.ascx" TagName="Toolbaar_cre"   TagPrefix="tool_cre"%>
            ...
            <td align="left">
                <ul id="navbarBankFile">                
                      ...
                      <asp:LinkButton ID="Link_Till" runat="server" CssClass="toolbaar1_link" PostBackUrl="~/Customer/Update_Till.aspx"
                        ...
                        <li>
                            <asp:LinkButton ID="Link_Customer_Credit" runat="server" Font-Bold="True" ForeColor="#2E95C9" 
                    ...
                    <td class="style3">
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                           ...
                           <%-- <tr>
                            ...
                            <tr class="toolbaar1_tr">
                                <td class="toolbaar1_td_rep">
                                    <asp:LinkButton ID="Link_creditrec" runat="server"  CssClass="toolbaar1_link_active"   PostBackUrl="~/Customer/Customer_CreditRec.aspx"  TabIndex="2">Credit Recieved</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
        ...
        <table align="left" class="w100">
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td>
                                    <asp:TextBox ID="txtto" runat="server" CssClass="align-center_teller" Width="100px"> </asp:TextBox> &nbsp;&nbsp;&nbsp; 
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <asp:Button ID="Button1" runat="server" Text="Create Credit Received Records Report" CssClass="btn" />
                        ...
                        <tr>
                            <td colspan="3" style="text-align: center;">
                                        <br /> 
                                        <asp:Button ID="btnrecre" runat="server"  Text="Re-create Again"  Visible="false" CssClass="align_mid" />&nbsp;&nbsp;&nbsp;
                                        <asp:Button ID="btnrecview" runat="server"  Text="View & Print" Visible="false" CssClass="align_mid"  />
                                        <br />
                                        <br />
                            </td>
                        </tr>
