<%@ Page Language="VB" Culture="en-AU" EnableEventValidation ="false" AutoEventWireup="false" CodeFile="Bank Detail.aspx.vb" Inherits="Customer_Bank_Detail" %>
...
<%@ Register Src="~/toolbaar/update_bank.ascx" TagName="Toolbaar4"  TagPrefix="tool4"%>
                ...
                <table cellspacing="0" cellpadding="0" width="98%"  >
                    ...
                    <td style="border:1px solid gray; width:82%;vertical-align :top">
                        ...
                        <br />
                                ...
                                <tool4:Toolbaar4 ID="tool4" runat="server" />                     
