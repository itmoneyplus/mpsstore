<%@ Page Language="VB" Culture="en-AU" EnableEventValidation ="false"  AutoEventWireup="false" CodeFile="Cheque Detail.aspx.vb" Inherits="Customer_Detail"  maintainScrollPositionOnPostBack="false" %>
<%@ Register Src="~/toolbaar/tool_main.ascx"  TagName="Toolbaar1"   TagPrefix="tool1"%>
<%@ Register Src="~/toolbaar/Cheque_detail.ascx" TagName="Tool_Chedet" TagPrefix ="tl_det"%>
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <tl_det:Tool_Chedet ID="tl_chedet"  runat="server" />
