<%@ Page Language="VB" Culture="en-AU" AutoEventWireup="false" CodeFile="Customer_CreditDue.aspx.vb" Inherits="Customer_Customer_CreditDue" %>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="toolbar_table">
                            <tr class="toolbaar1_tr">
                                <td class="toolbaar1_td_rep">
                                   <asp:LinkButton ID="Link_creditdue" runat="server"  CssClass="toolbaar1_link_active" PostBackUrl="~/Customer/Customer_CreditDue.aspx" TabIndex="1" >Credit Due</asp:LinkButton>
                                </td>
                            </tr>
                           <%-- <tr >
                                <td>
    ...
    <br />
        <table align="left" class="w100">
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <asp:Button ID="Button1" runat="server" Text="Reterive Credit Due Report" CssClass="btn"/>
                        ...
                        <tr>
                            <td colspan="3" style="text-align: center;">
                                     <asp:Button ID="btnduere" runat="server"  Text="Record Payment"  Visible="false" />&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="btndueview" runat="server"  Text="View & Print" Visible="false"  />
                                <br />
                                <br />
                            </td>
                        </tr>
