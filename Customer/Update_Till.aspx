<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Update_Till.aspx.vb" Inherits="Customer_Update_Safe" %>
        ...
        <tr>
            <td align="left">
                <ul id="navbarBankFile">
                    ...
                    <li >
                  <asp:LinkButton ID="Link_Till" runat="server" Font-Bold="True" 
                                ForeColor="#2E95C9"  PostBackUrl="~/Customer/Update_Till.aspx"
    ...
    <br />
            <table align="left" class="w100">
                          ...
                          <tr>
                            ...
                            <p>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Update Your Specific Till</b></p>
                            </td>
                        </tr>
                         <tr>
                            <td style="width:5px ;padding-top:5px; padding-bottom:20px;">
                                <img src="../Images/White_Right_Arrow.GIF" alt="" style="margin-left:60px;" />
                                <asp:Label ID="label1" runat="server" CssClass="label_style">Description:</asp:Label>
                            </td>
                            <td>
                                    <asp:DropDownList ID="DropDownList1" runat="server" CssClass="droplist_updatetill">
                        ...
                        <tr>
                            <td style="width:5px; padding-bottom:20px;">
                                <img src="../Images/White_Right_Arrow.GIF" alt=""  style="margin-left:60px;" />
                                <asp:Label ID="label2" runat="server" CssClass="label_style">Enter amount:</asp:Label>
                            </td>
                            <td>
                         ...
                         <tr>
                            <td style="width:5px; padding-bottom:20px;">
                                <img src="../Images/White_Right_Arrow.GIF" alt="" style="margin-left:60px;" />
                                <asp:Label ID="label3" runat="server" CssClass="label_style">Teller:</asp:Label>
                            </td>
                            <td >
                        ...
                        <tr>
                            <td></td>
                            <td>
                              <asp:Button ID="btn_till" runat="server" text="Update Till" CssClass="btn_BankFile" />  
                            </td>
                            <td></td>
                        </tr>
                        <tr >
