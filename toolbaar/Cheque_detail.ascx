<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Cheque_detail.ascx.vb" Inherits="toolbaar_Cheque_detail" %>
  <head>
  ...
  <div align="center" >
   ...
   <tr>
    ...
    <td rowspan="4" width="38%" colspan="2" style="font-family: Gungsuh">
	<font style="text-align:center;font-family:Times New Roman;font-size:6;color:red"></font></td>
	</tr>
    <tr>
    ...
    <tr><td colspan="6">&nbsp;</td></tr>
     ...
     <tr><td>
   	 ...
   	 <asp:Button ID="btndis" runat="server" Text="Dishonour" />
     </td></tr>
     </table>
     </div>
